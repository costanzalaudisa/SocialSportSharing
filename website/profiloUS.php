        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
							<form action ="profiloUS.php" method="post">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="profiloUS.php">Profilo</a></li>
    				...
    				<div class="row">
                        <div class="col-lg-2">
                            ...
                            <div class="panel panel-info">
	                            ...
	                            <!--ALTRE ATTIVITA' CHE PUO' FARE UN UTENTE US-->                           
    	                        <div class="btn-group-vertical">                                
        	                        <a href="scegliValutazione.php" class="btn btn-default">VALUTAZIONI</a>
	    					...
	    					<div class="col-lg-10">
    							<h1><?php echo $Nome."  ".$Cognome." - US" ?></h1>
