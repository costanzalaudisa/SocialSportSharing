        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
                    ...
                    echo '<table class="table" id="tabcategorie">';
                    while ($row = $categoria -> fetch()){
                        echo '<tr>';
                        echo '<th><center>',$row["Sport"],'</center><div class="thumbnail"><img src="images/',$row["Foto"],'" alt="Image"></div></th>';
                        echo '<td>',$row["Regolamento"],'</td>';
                        echo '</tr>';
                    }
                    echo '</table>';
                    $connection = NULL;
